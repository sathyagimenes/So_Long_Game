...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   entity_validation_bonus.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: sde-cama <sde-cama@student.42sp.org.br>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/17 09:48:59 by sde-cama          #+#    #+#             */
/*   Updated: 2022/10/30 02:25:32 by sde-cama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	verify_entities(t_program *program)
{
	...
	while (x < nrow - 1)
	{
		...
		while (y < ncolumn - 1)
		{
			if (grid[x][y] != PLAYER_POSITION && grid[x][y] != EXIT &&
			grid[x][y] != COLLECTIBLE && grid[x][y] != EMPTY_SPACE &&
			grid[x][y] != WALL && grid[x][y] != ENEMY)
